     ...
     if(banco==1){
				  switch(movimiento){
									 ...
									 case 5: cout<<"Cuanto se gasto::"; cin>>transferencia; banco_LaEsperanza(movimiento,transferencia);
									 	  	 gasto += transferencia; diarios(movimiento,transferencia);// 'gasto' sirve para Edo. Resultado
											 break;
									 ...
									 default: system("cls"); getch(); empresa(); break;       }
                                                ...
                                                switch(movimiento){
							 									   ...
							 									   case 5: cout<<"Cuanto se gasto::"; cin>>transferencia; banco_Maya(movimiento,transferencia);
							 									           gasto += transferencia; diarios(movimiento,gasto);
											 					   		   break;
                                                                    case 6: cout<<"laEsperanza->$"<<dinero_LaEsperanza<<endl;
									 	  	 							 	cout<<"Maya->$"<<dinero_Maya<<endl;
									 	  	 							 	break;
...
void estadoResultado(){
	 cout<<" + Ventas->\t"<<ventas<<endl;
	 cout<<" - Costo ->\t"<<costo<<endl;
	 cout<<" = UtilidadBruta->"<<utilidad<<endl;
	 cout<<" - Gastos->"<<gasto<<endl;
	 cout<<" == Utilida/Perdida->"<<resNeto<<endl;
	 }
