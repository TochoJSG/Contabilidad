...
int main(){//Funcion Principal
 	do{
		...
		cout<<"\nDigite la cantidad con la que empezaremos en banco 'Maya' :: "; cin>>banco.dinero_Maya;
		cout<<"\nDigite el valor de la mercancia, con la que empezaremos en Almacen :: "; cin>>movimientos.ctas.inventario;
	 ...
	 if(opc_banco==1){
				  switch(movimiento){
				 					 case 1: system("cls"); cout<<"\n\t.:Compra de Mercancia:."<<endl;
				 					         cout<<"Si sera todo a credito sin dar nada digite 0 a Bancos, si no digite lo que se dara"<<endl;
...
void diarios(short opcion,float cargo){
	 ...
	 switch(opcion){
					case 1: cout<<"\a\n\tLa compra sera a credito o de Contado"<<endl;
					        cout<<"\t\t1.Credito\n\t\t2.Contado"<<endl; cin>>opc_pago;
					        if(opc_pago==1){
											cout<<"Valor de la mercancia::"; cin>>credito;
                                            cout<<"  Almacen->"<<credito<<endl;//Cargamos el valor Sin iva de la Nota/Factura
...
//                                          Asiento que afecta a los diarios si se dio adelanto o una parte
									...
									break;
					case 3: cout<<"\a\n\tLa Venta sera a credito o de Contado"<<endl;
					        cout<<"\t\t1.Credito\n\t\t2.Contado"<<endl; cin>>opc_pago;
					        if(opc_pago==1){
											cout<<"Valor de la mercancia::"; cin>>credito;
...
//                                          Asiento que afecta a los diarios si se dio adelanto o una parte
				    ...
				    case 4: cout<<"\a\n\tLa Venta sera a credito o de Contado"<<endl;
					        ...
					        if(opc_pago==1){
                                            ...
                                            cout<<"Deudores diversos->"<<credito/1.16<<endl;//Cargamos el valor Sin iva de la Nota/Factura
						    	 			cout<<"     	     Iva->"<<credito*.16<<endl;//Iva sobre valor total de mercancia
